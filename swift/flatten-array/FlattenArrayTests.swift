...
class FlattenArrayTests: XCTestCase {
    ...
    func testFlattenForSixLevelDeepNestedListWithNullTalues() {
    ...
    func testFlattenForStringTaluesInSixLevelDeepNestedList() {
    ...
    func testFlattenForDoubleTaluesInFiveLevelDeepNestedList() {
